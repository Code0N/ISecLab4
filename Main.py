...
def gcd(a, b):
    while b != 0:
        ...
        a = b
        b = c
    # а будет возвращено, если b == 0
    return a    

def modexp(base, exp, modulus): #расчитывает base^exp
    return pow(base, exp, modulus)

# Тест первичности Соловай-Штрассена. проверяет, является ли число простым
...
def decrypt(key, cipher):
    ...
    if (not len(cipherArray) % 2 == 0):
        return "Повреждённый шифротекст"
